...
export default defineConfig({
  ...
  //gerar funções com fetch do next.js(next tem fetch com padrões especificos dele). dentro de /app/_lib/api/fetch-generated/index.ts", gere as funções automaticas 
  fetch: {
